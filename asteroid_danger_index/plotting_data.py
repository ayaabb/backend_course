...
def plot_barChart(values, names):  # plotting the danger index for each asteroid
...
def plot_graph(asteroids, X_key, Y_key):  # plotting the relation between two factors
